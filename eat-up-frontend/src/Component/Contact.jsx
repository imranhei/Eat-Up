        ...
        <div className="flex items-center justify-center h-screen w-full relative overflow-hidden pt-12">
                ...
                <div className="md:w-[600px] w-80 h-fit bg-black z-10 bg-opacity-80 rounded-md overflow-hidden text-white md:pb-16 pb-12 border border-y-cyan-400 border-x-red-400">
                    ...
                    <div className="flex py-2 md:mt-8 mt-4">
                        ...
                        <input type="text" className='outline-none border-b md:w-96 w-44 border-slate-50/40 bg-transparent focus:border-teal-400'/>
                    </div>
                    <div className="flex py-2">
                        <h1 className='md:w-32 w-24 text-right mr-2'>Email :</h1>
                        <input type="mail" className='outline-none border-b md:w-96 w-44 border-slate-50/40 bg-transparent focus:border-teal-400'/>
                    </div>
                    <div className="flex py-2">
                        <h1 className='md:w-32 w-24 text-right mr-2'>Phone :</h1>
                        <input type="number" className='outline-none border-b md:w-96 w-44 border-slate-50/40 bg-transparent focus:border-teal-400'/>
                    </div>
                    <div className="flex py-2">
                        <h1 className='md:w-32 w-24 text-right mr-2'>Message :</h1>
                        <textarea rows="4" className='outline-none border-b border-slate-50/40 bg-transparent focus:border-teal-400 mb-6 max-h-40 md:w-96 w-44'></textarea>
                    </div>
                    <button className='block m-auto bg-teal-400 rounded-full px-16 py-1 font-semibold border border-transparent hover:border-teal-400 hover:text-teal-400 hover:bg-transparent'>Submit</button>
                </div>
        </div>
    );
}
