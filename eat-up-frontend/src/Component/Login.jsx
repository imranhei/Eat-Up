            ...
            <div className="bg-black p-16 w-96 h-fit flex flex-col gap-2 items-center rounded-lg text-sm mt-12 bg-opacity-50 border border-y-cyan-400 border-x-red-400">
                ...
                <div className='border-b border-gray-600 pb-1 focus-within:border-teal-400 w-full'>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <input onChange={e => setUserName(e.target.value)} type="text" placeholder='Type your username' className='outline-none w-full bg-transparent'/>
                    </div>
                </div>
                <div className='border-b border-gray-600 pb-1 focus-within:border-teal-400 w-full'>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <input onChange={e => setPass(e.target.value)} type="password" placeholder='Type your password'  className='outline-none w-full bg-transparent'/>
                    </div>
                </div>
